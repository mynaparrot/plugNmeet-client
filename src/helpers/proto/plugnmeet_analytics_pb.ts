...
export enum AnalyticsEvents {
   ...
   * room recorder
   *
   * @generated from enum value: ANALYTICS_EVENT_ROOM_RECORDING_STATUS = 3;
   */
  ANALYTICS_EVENT_ROOM_RECORDING_STATUS = 3,

  /**
   * @generated from enum value: ANALYTICS_EVENT_ROOM_RTMP_STATUS = 4;
   */
  ANALYTICS_EVENT_ROOM_RTMP_STATUS = 4,

  /**
   * @generated from enum value: ANALYTICS_EVENT_ROOM_BREAKOUT_ROOM = 5;
   */
  ANALYTICS_EVENT_ROOM_BREAKOUT_ROOM = 5,

  /**
   * @generated from enum value: ANALYTICS_EVENT_ROOM_ETHERPAD_STATUS = 6;
   */
  ANALYTICS_EVENT_ROOM_ETHERPAD_STATUS = 6,

  /**
   * @generated from enum value: ANALYTICS_EVENT_ROOM_EXTERNAL_DISPLAY_LINK_STATUS = 7;
   */
  ANALYTICS_EVENT_ROOM_EXTERNAL_DISPLAY_LINK_STATUS = 7,

  /**
   * @generated from enum value: ANALYTICS_EVENT_ROOM_EXTERNAL_MEDIA_PLAYER_STATUS = 8;
   */
  ANALYTICS_EVENT_ROOM_EXTERNAL_MEDIA_PLAYER_STATUS = 8,

  /**
   * @generated from enum value: ANALYTICS_EVENT_ROOM_SPEECH_SERVICE_STATUS = 9;
   */
  ANALYTICS_EVENT_ROOM_SPEECH_SERVICE_STATUS = 9,

  /**
   * @generated from enum value: ANALYTICS_EVENT_ROOM_SPEECH_SERVICE_TOTAL_USAGE = 10;
   */
  ANALYTICS_EVENT_ROOM_SPEECH_SERVICE_TOTAL_USAGE = 10,

  /**
   * @generated from enum value: ANALYTICS_EVENT_ROOM_INGRESS_CREATED = 11;
   */
  ANALYTICS_EVENT_ROOM_INGRESS_CREATED = 11,

  /**
   * @generated from enum value: ANALYTICS_EVENT_ROOM_WHITEBOARD_FILES = 12;
   */
  ANALYTICS_EVENT_ROOM_WHITEBOARD_FILES = 12,

  /**
   * here all related with user
   *
   * @generated from enum value: ANALYTICS_EVENT_USER_LEFT = 13;
   */
  ANALYTICS_EVENT_USER_LEFT = 13,

  /**
   * microphone
   *
   * @generated from enum value: ANALYTICS_EVENT_USER_MIC_STATUS = 14;
   */
  ANALYTICS_EVENT_USER_MIC_STATUS = 14,

  /**
   * @generated from enum value: ANALYTICS_EVENT_USER_TALKED = 15;
   */
  ANALYTICS_EVENT_USER_TALKED = 15,

  /**
   * webcam
   *
   * @generated from enum value: ANALYTICS_EVENT_USER_WEBCAM_STATUS = 16;
   */
  ANALYTICS_EVENT_USER_WEBCAM_STATUS = 16,

  /**
   * screen share
   *
   * @generated from enum value: ANALYTICS_EVENT_USER_SCREEN_SHARE_STATUS = 17;
   */
  ANALYTICS_EVENT_USER_SCREEN_SHARE_STATUS = 17,

  /**
   * polls
   *
   * @generated from enum value: ANALYTICS_EVENT_USER_VOTED_POLL = 18;
   */
  ANALYTICS_EVENT_USER_VOTED_POLL = 18,

  /**
   * chat
   *
   * @generated from enum value: ANALYTICS_EVENT_USER_PUBLIC_CHAT = 19;
   */
  ANALYTICS_EVENT_USER_PUBLIC_CHAT = 19,

  /**
   * @generated from enum value: ANALYTICS_EVENT_USER_PRIVATE_CHAT = 20;
   */
  ANALYTICS_EVENT_USER_PRIVATE_CHAT = 20,

  /**
   * @generated from enum value: ANALYTICS_EVENT_USER_CHAT_FILES = 21;
   */
  ANALYTICS_EVENT_USER_CHAT_FILES = 21,

  /**
   * whiteboard
   *
   * @generated from enum value: ANALYTICS_EVENT_USER_WHITEBOARD_ANNOTATED = 22;
   */
   ...
   */
  ANALYTICS_EVENT_USER_CONNECTION_QUALITY = 28,
}
...
proto3.util.setEnumType(AnalyticsEvents, 'plugnmeet.AnalyticsEvents', [
  ...
  { no: 3, name: 'ANALYTICS_EVENT_ROOM_RECORDING_STATUS' },
  { no: 4, name: 'ANALYTICS_EVENT_ROOM_RTMP_STATUS' },
  { no: 5, name: 'ANALYTICS_EVENT_ROOM_BREAKOUT_ROOM' },
  { no: 6, name: 'ANALYTICS_EVENT_ROOM_ETHERPAD_STATUS' },
  { no: 7, name: 'ANALYTICS_EVENT_ROOM_EXTERNAL_DISPLAY_LINK_STATUS' },
  { no: 8, name: 'ANALYTICS_EVENT_ROOM_EXTERNAL_MEDIA_PLAYER_STATUS' },
  { no: 9, name: 'ANALYTICS_EVENT_ROOM_SPEECH_SERVICE_STATUS' },
  { no: 10, name: 'ANALYTICS_EVENT_ROOM_SPEECH_SERVICE_TOTAL_USAGE' },
  { no: 11, name: 'ANALYTICS_EVENT_ROOM_INGRESS_CREATED' },
  { no: 12, name: 'ANALYTICS_EVENT_ROOM_WHITEBOARD_FILES' },
  { no: 13, name: 'ANALYTICS_EVENT_USER_LEFT' },
  { no: 14, name: 'ANALYTICS_EVENT_USER_MIC_STATUS' },
  { no: 15, name: 'ANALYTICS_EVENT_USER_TALKED' },
  { no: 16, name: 'ANALYTICS_EVENT_USER_WEBCAM_STATUS' },
  { no: 17, name: 'ANALYTICS_EVENT_USER_SCREEN_SHARE_STATUS' },
  { no: 18, name: 'ANALYTICS_EVENT_USER_VOTED_POLL' },
  { no: 19, name: 'ANALYTICS_EVENT_USER_PUBLIC_CHAT' },
