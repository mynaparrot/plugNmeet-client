...
const BreakoutRoomDuration = ({ duration, created }: IDurationProps) => {
  ...
  return (
    <>
      <div className="timer text-xs md:text-sm border border-solid border-primaryColor dark:border-secondaryColor dark:text-secondaryColor sm:py-[2px] px-3 rounded-br-lg -mt-[1px] -ml-[1px]">
        {remaining}
      </div>
    </>
  );
