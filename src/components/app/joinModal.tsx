    ...
    return (
      ...
      >
        <div className="popup-inner bg-white w-full max-w-sm rounded-3xl shadow-header relative px-6 py-14">
          ...
          <p className="text-base text-[#004D90] font-normal mb-5 text-center">
            {t('app.how-to-join')}
          </p>
          <div className="btn flex justify-center">
            <button
              ...
              onClick={() => shareMic()}
            >
              <div className="h-[40px] w-[40px] m-auto overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mb-1 flex items-center justify-center cursor-pointer">
                <i className="pnm-mic-unmute brand-color1" />
              </div>
              <p className="text-sm brand-color1 font-normal">
                {t('app.microphone')}
              </p>
            </button>
            <button
            ...
            >
              <div
                className="camera h-[40px] w-[40px] m-auto overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mb-1 flex items-center justify-center cursor-pointer"
                onClick={() => onClose()}
              >
                <i className="pnm-listen-only brand-color1" />
              </div>
              <p className="text-sm brand-color1 font-normal">
                {t('app.listen-only')}
              </p>
