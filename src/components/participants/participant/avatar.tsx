...
const Avatar = ({ participant }: IAvatarProps) => {
  ...
  return (
    <div className="thumb h-[22px] xl:h-[30px] w-[22px] xl:w-[30px] mr-2 rounded-full overflow-hidden bg-primaryColor flex items-center justify-center text-white text-xs xl:text-sm">
      {render()}
    </div>
  );
};
